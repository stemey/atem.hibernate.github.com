...
public class EnumAttributeType extends AttributeType
{
	...
	{
		Class returnedClass = propertyDescriptor.getPropertyType();
		PrimitiveType primitiveType = primitiveTypeFactory.getPrimitiveType(returnedClass);
		return primitiveType != null && primitiveType instanceof ChoiceType;
	}
