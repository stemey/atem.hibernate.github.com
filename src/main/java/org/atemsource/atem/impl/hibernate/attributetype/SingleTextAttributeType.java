...
public class SingleTextAttributeType extends AttributeType
{
	...
	{
		return attributeType instanceof TextType || attributeType instanceof StringType;
	}
		...
		final Type attributeType, final SessionFactoryImplementor sessionFactoryImplementor)
	{
		...
		final SimpleTextType textType = new SimpleTextType();
		attribute.setTargetType(textType);
		// textType.setMaxLength(validationMetaData.getMaxLength(attribute));
		return attribute;
	}
